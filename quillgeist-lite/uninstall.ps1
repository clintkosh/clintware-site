...
$startupShortcut = Join-Path ([Environment]::GetFolderPath("Startup")) "Clintware Quillgeist Lite.lnk"
$commonShortcut = Join-Path ([Environment]::GetFolderPath("CommonStartup")) "Clintware Quillgeist Lite.lnk"
