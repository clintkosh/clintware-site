const PRODUCT = Object.freeze({
  ...
  lede: "ShoulderSoldier is a provider-independent security layer designed to inspect sensitive email content and apply local policy before exposure to a downstream email or AI provider.",
  ...
  points: [
    ...
    ["Provider independent", "Design around the user and policy boundary instead of depending on one mail platform's controls."],
  ...
  footer: "Protect the message before the provider becomes the first place that can inspect it."
});
...
<meta property="og:type" content="website"><meta property="og:title" content="ShoulderSoldier | Clintware"><meta property="og:description" content="${escapeHtml(PRODUCT.headline)}"><meta property="og:url" content="${canonical}">
<meta name="theme-color" content="#070a0f"><title>ShoulderSoldier | Clintware</title>
...
<header class="wrap top"><a class="brand" href="https://www.clintware.com/">CLINT<b>WARE</b> / SHOULDERSOLDIER</a><a class="back" href="https://www.clintware.com/">clintware.com ↗</a></header>
