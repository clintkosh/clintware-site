function body(){
 ...
 if(tab==='handoff')return page('handoff','Sales-to-CS handoff','Scope, promise, business case, systems, and validation.',[["title","Item"],["value","Value"],["validation","Validation"],["note","Notes"]])+'<div class="section"><h2>Systems & integrations</h2><button class="btn" data-add="integration">Add integration</button></div>'+table('integration',[["name","System"],["purpose","Purpose"],["connectorStatus","Status"],["technicalValidation","Validation"]]);
