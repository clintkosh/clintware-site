...
let S={customer:null,customers:[],records:[],workspace:null,access:{authenticated:false,mode:"guest"}},K={articles:[],latest:[],trending:[],config:{},usageSignalAvailable:false},I={jira:null,confluence:null,controlPlane:null,ai:null},tab="customers",scen=new Set(),theme=localStorage.getItem("n7theme")||"dark";
