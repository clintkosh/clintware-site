...
let S={customer:null,customers:[],records:[],workspace:null},K={articles:[],latest:[],trending:[],config:{},usageSignalAvailable:false},I={jira:null,confluence:null,controlPlane:null},tab="command",scen=new Set(),theme=localStorage.getItem("n7theme")||"dark";
