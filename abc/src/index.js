...
:root{--ui-navy:#071a3d;--ui-blue:#2867e8;--ui-mint:#67e8c1;--ui-cyan:#32c7e8;--ui-violet:#7d68ee}
#gate,#gate *{box-sizing:border-box}#gate{min-height:100vh;background:var(--ui-navy);color:#fff;font-family:Arial,Helvetica,sans-serif;overflow:hidden}.gate-nav{height:82px;display:flex;align-items:center;justify-content:space-between;padding:0 clamp(22px,5vw,76px);background:#fff;color:var(--ui-navy);position:relative;z-index:3}.gate-brand{font-size:18px;font-weight:800;letter-spacing:-.02em}.gate-nav-note{font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#40506d}.gate-hero{min-height:calc(100vh - 82px);display:grid;grid-template-columns:minmax(0,1.15fr) minmax(360px,.85fr);align-items:center;gap:clamp(38px,7vw,110px);padding:clamp(44px,7vw,92px) clamp(22px,7vw,104px);position:relative;isolation:isolate}.gate-hero:before{content:"";position:absolute;width:min(52vw,760px);aspect-ratio:1;right:-16%;top:-30%;border:1px solid rgba(103,232,193,.33);border-radius:44% 56% 51% 49%;transform:rotate(24deg);box-shadow:0 0 0 74px rgba(50,199,232,.05),0 0 0 150px rgba(125,104,238,.04);z-index:-1}.gate-hero:after{content:"";position:absolute;width:360px;height:360px;left:-170px;bottom:-210px;border-radius:50%;background:radial-gradient(circle at 62% 38%,var(--ui-cyan),var(--ui-blue) 45%,transparent 68%);filter:blur(2px);opacity:.55;z-index:-1}.gate-copy{max-width:760px}.gate-kicker{display:inline-flex;align-items:center;gap:9px;font-size:11px;letter-spacing:.13em;text-transform:uppercase;font-weight:800;color:var(--ui-mint);margin-bottom:22px}.gate-kicker:before{content:"";width:34px;height:2px;background:var(--ui-mint)}.gate-copy h1{font-size:clamp(44px,6vw,84px);line-height:.94;letter-spacing:-.065em;margin:0 0 24px;max-width:760px}.gate-copy p{font-size:clamp(17px,1.7vw,22px);line-height:1.45;color:#d8ebff;max-width:660px;margin:0}.gate-proof{display:flex;flex-wrap:wrap;gap:9px;margin-top:31px}.gate-proof span{border:1px solid rgba(255,255,255,.3);border-radius:999px;padding:8px 13px;font-size:11px;font-weight:700;color:#fff;background:rgba(255,255,255,.06);backdrop-filter:blur(8px)}.gate-card{width:min(470px,100%);justify-self:end;align-self:start;padding:clamp(26px,4vw,42px);background:#fff;color:var(--ui-navy);border-radius:28px;box-shadow:0 36px 100px rgba(0,8,30,.38);position:relative}.gate-card:before{content:"";position:absolute;left:30px;right:30px;top:0;height:5px;border-radius:0 0 99px 99px;background:linear-gradient(90deg,var(--ui-blue),var(--ui-cyan),var(--ui-mint))}.gate-card .gate-card-kicker{font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--ui-blue);font-weight:900}.gate-card h2{font-size:clamp(28px,3vw,38px);line-height:1.02;letter-spacing:-.05em;margin:10px 0 13px}.gate-card>p{color:#40506d;line-height:1.55;margin:0 0 27px;font-size:14px}.gate-card label{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.11em;font-weight:900;color:var(--ui-navy);margin-bottom:8px}.gate-card input{width:100%;background:#f7faff;border:1px solid #ccd5e3;color:var(--ui-navy);border-radius:999px;padding:15px 18px;font-size:16px;outline:none}.gate-card input:focus{border-color:var(--ui-blue);box-shadow:0 0 0 4px rgba(40,103,232,.15)}.gate-card button{width:100%;border:0;border-radius:999px;padding:15px 20px;margin-top:13px;background:var(--ui-mint);color:var(--ui-navy);font-size:15px;font-weight:900;cursor:pointer;transition:transform .16s ease,box-shadow .16s ease}.gate-card button:hover{transform:translateY(-1px);box-shadow:0 12px 26px rgba(40,103,232,.2)}.gate-card button:focus-visible{outline:3px solid var(--ui-blue);outline-offset:3px}.gate-error{min-height:19px;color:#b00037;font-size:12px;font-weight:700;margin-top:9px}.gate-fine{font-size:10px;color:#66728a;margin-top:17px;line-height:1.55;padding-top:16px;border-top:1px solid #e8eef7}
...
const DTEX_GATE_HTML = `<main id="gate"><header class="gate-nav"><div class="gate-brand">Customer Success Operations</div><div class="gate-nav-note">For interview purposes for Clinton Kosh</div></header><div class="gate-hero"><section class="gate-copy"><div class="gate-kicker">Restricted preview</div><h1>Know what needs attention.</h1><p>Bring account health, customer context, meetings, and renewal readiness into one practical workspace.</p><div class="gate-proof" aria-label="Demo features"><span>Portfolio health</span><span>Account workspaces</span><span>Meeting readiness</span></div></section><section class="gate-card"><div class="gate-card-kicker">Authorized access</div><h2>Private Customer Success Demo</h2><p>Enter the access password to continue to the synthetic demonstration.</p><form id="access-form" autocomplete="off"><label for="pw">Access password</label><input id="pw" type="password" autocomplete="current-password" autofocus><button type="submit">Unlock demo</button><div id="gate-error" class="gate-error" role="alert"></div></form><div class="gate-fine">For interview purposes for Clinton Kosh. Synthetic data only. Metrics and thresholds are explicit and deterministic.</div></section></div></main>`;
