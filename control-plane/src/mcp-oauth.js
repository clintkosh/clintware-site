...
const MCP_RESOURCE = "https://mcp.clintware.com/mcp";
const MCP_ISSUER = "https://mcp.clintware.com";
const AUTH_CONFIG_URL = "https://auth.clintware.com/client-config/control-plane-mcp";
...
export const mcpOAuthProvider = new OAuthProvider({
  ...
  resourceMetadata: {
    ...
    resource_documentation: "https://mcp.clintware.com/",
  },
