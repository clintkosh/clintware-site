...
param(
    ...
    [string]$WorkerName = "clintware-control-plane",
    [string]$ZoneName = "clintware.com",
...
Write-Host "Clintware Control Plane bootstrap" -ForegroundColor Green
...
# ---------------------------------------------------------------------------
# 4. Install infrastructure credentials into clintware-control-plane.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
Write-Step "Testing mcp.clintware.com"
try {
    $health = Invoke-RestMethod -Uri "https://mcp.clintware.com/health" -Method GET -TimeoutSec 20
    Write-Host "mcp.clintware.com health: OK" -ForegroundColor Green
} catch {
