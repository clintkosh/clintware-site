...
export const BASE_HELP={
  ...
  getting_started:[
    ...
    {id:"local-ai",title:"Local AI manager",body:"Use `quillgeist local-ai status` to inventory installed local runtimes/models, `fit MODEL` to review the conservative memory envelope, `route` to select a viable installed local model, and `benchmark MODEL` for a bounded measurement. These commands do not implicitly download models."},
