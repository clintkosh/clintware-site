...
Canonical professional brand treatment, effective 2026-08-19.
...
- **Quillgeist**: flagship product / YC priority. Adaptive AI execution layer that improves user intent for the model/tool being used, routes eligible work to local execution where possible, and is being developed to learn from accepted edits, rejected edits, preferences, and outcomes.
