  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/health") {
      return Response.json({
        ...
        identityProviderPolicy: "application-scoped-federation",
